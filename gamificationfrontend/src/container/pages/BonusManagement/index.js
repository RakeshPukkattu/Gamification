...
const Dashboard = () => {
  ...
  return (
    <>
      <PageHeader title="Bonus Management Dashboard" />
      <Main>
        <Row gutter={25}>
          <Col sm={24} xs={24}>
            <ExportStyleWrap>
      ...
      >
        <Form name="AddBonus" form={form} onFinish={handleSubmit} layout="vertical">
          <Form.Item
            name="bonusName"
            label="Bonus Name"
            rules={[{ message: 'Please enter bonus name', required: true }]}
          >
            <Input
