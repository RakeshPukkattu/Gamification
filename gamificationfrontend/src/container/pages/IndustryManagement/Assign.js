...
const Assign = () => {
  ...
  const handleSubmit = values => {
    ...
    let theme = [];
    console.log(indutryDetails);
    if (indutryDetails.themes.length !== 0) {
      ...
      .then(function(response) {
        ...
        if (result.code.includes('406')) {
          ...
          history.push({
            ...
            state: { detail: `Games Assigned Successfully` },
          });
        }
      })
                ...
                <Form name="adduser" form={form} onFinish={handleSubmit} layout="vertical">
                  ...
                  <div className="sDash-button-grp">
                    <Button
                      ...
                      disabled={loading}
                    >
                      {loading2 ? <Spin size="medium" /> : 'Assign Games'}
                    </Button>
                  </div>
                </Form>
                <div>
