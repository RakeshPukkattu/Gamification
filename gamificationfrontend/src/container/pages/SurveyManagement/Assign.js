...
import { Row, Col, Table, Switch, Select, Input, Spin, Form, Alert, Radio } from 'antd';
...
const Assign = () => {
  ...
  const getCurrentUserCountryForGroup = () => {
  ...
  return (
    <>
      <PageHeader title="Assign Survey" />
      <Main>
        <Row gutter={25}>
          <Col sm={24} xs={24}>
