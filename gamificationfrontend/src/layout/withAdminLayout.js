...
const ThemeLayout = WrappedComponent => {
  class LayoutComponent extends Component {
    ...
    render() {
      const { collapsed, hide, searchHide, activeSearch, role } = this.state;
      const { rtl, topMenu, changeRtl, changeLayout } = this.props;
                ...
                <Content>
                  ...
                  {role ? (
                    <Footer className="admin-footer" style={footerStyle}>
                      <Row>
                        <Col md={12} xs={24}>
                          <span className="admin-footer__copyright">{new Date().getFullYear()} © ZISPL</span>
                        </Col>
                        <Col md={12} xs={24}>
