...
import com.zisbv.gamification.service.FileStorageComponentService;
import com.zisbv.gamification.util.AppConstants;

@Service(value = "fileStorageComponentService")
public class FileStorageComponentServiceImpl implements FileStorageComponentService {

	private final Path fileStorageLocation;

	@Autowired
	public FileStorageComponentServiceImpl(FileStorageProperties fileStorageProperties) {
		this.fileStorageLocation = Paths.get(fileStorageProperties.getComponentDir()).toAbsolutePath().normalize();
