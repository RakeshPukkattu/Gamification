...
@Service(value = "fileStorageGameService")
public class FileStorageGameServiceImpl implements FileStorageGameService {

	private final Path fileStorageLocation;

	@Autowired
	public FileStorageGameServiceImpl(FileStorageProperties fileStorageProperties) {
		this.fileStorageLocation = Paths.get(fileStorageProperties.getGameDir()).toAbsolutePath().normalize();
